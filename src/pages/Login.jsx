      ...
      >
        <div className="glass p-8 sm:p-10 rounded-[32px] shadow-2xl relative z-10 border border-white/10">
          <div className="text-center mb-8">
            <Link to="/" className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-premium shadow-lg shadow-primary/20 mb-6 group hover:scale-105 transition-transform">
